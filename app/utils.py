...
# load all the models
haar = cv2.CascadeClassifier('app/model/haarcascade_frontalface_default.xml')
# pickle files
mean  = pickle.load(open('app/model/mean_preprocess.pickle','rb'))
model_svm  = pickle.load(open('app/model/model_svm.pickle','rb'))
model_pca  = pickle.load(open('app/model/pca_50.pickle','rb'))
